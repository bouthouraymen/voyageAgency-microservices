...
public class ReclamationController {
	...
	public String addReclamation(@Valid @RequestBody Reclamation reclamation , @PathVariable String user) {
	...
	public String updateReclamation(@Valid @RequestBody Reclamation reclamation) {
	...
	*/
	...
	public String modifieretat(@Valid @RequestBody Reclamation reclamation) {
